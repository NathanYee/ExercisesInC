 ...
 *  GLib is a bundle of low-level libraries written primarily used and maintained by GNOME. It has been refined over the years by numerous people is is consequently extremely robust and elegant.
 * glibc is the GNU C Library - also known as the C standard library used by GCC.

*  What are the most important pros and cons of using GLib, as opposed
to another library, or just using core C features?
  * The GLib library is less bare bones and contains more higher level functions.
